...
fn main() {
    ...
    with_2d_graphics(|| {
        ...
        canvas.draw(|gc| {
            ...
            draw_tree(gc, SCR_HEIGHT/1.5, SCR_HEIGHT/10.0, 0.0, DEPTH);
    ...
    pub fn draw_tree(gc: &mut CanvasGraphicsContext, x : f32 ,y : f32, angle: f32, n: i32) {
        ...
        let color = Color::Rgba(rng.gen_range(0.1..=1.0), 0.0, rng.gen_range(0.1..=1.0), 1.0);
